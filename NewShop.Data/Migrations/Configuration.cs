namespace NewShop.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<NewShop.Data.NewShopDbContext>
    {
        ...
        protected override void Seed(NewShop.Data.NewShopDbContext context)
        {
            ...
            //{
            //    UserName = "ngoctan",
            //    Email = "chaungoctan@gmail.com",
            //    EmailConfirmed = true,
            //    BirthDay = DateTime.Now,
            //    FullName = "13 Cong nghe thong tin"
            ...
            //var adminUser = manager.FindByEmail("chaungoctan@gmail.com");

            //manager.AddToRoles(adminUser.Id, new string[] { "Admin", "User" });

        }
        private void CreateProductCategorySample(NewShop.Data.NewShopDbContext context)
        {
